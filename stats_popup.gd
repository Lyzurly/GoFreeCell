...
func refresh_stats():
	...
	challenge_level.text = "Lvl %s" % ChallengeDealUtility.get_challenge_lvl()
	challenge_progress_bar.max_value = ChallengeDealUtility.get_challenge_lvl_size()
	challenge_progress_bar.value = ChallengeDealUtility.get_challenge_lvl_progress()
	challenge_progress_label.text = "%s/%s" % [ChallengeDealUtility.get_challenge_lvl_progress(), ChallengeDealUtility.get_challenge_lvl_size()]
